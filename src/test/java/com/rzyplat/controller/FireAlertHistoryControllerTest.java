...
public class FireAlertHistoryControllerTest {

	@Autowired
	private MockMvc mockMvc;
	@MockBean
	private FireAlertHistoryService service;
	
	@Test
	public void getHistoryTest() throws Exception {
		FireAlertHistoryResponse response=new FireAlertHistoryResponse(0, 10, 2, 20l, List.of());
		
		when(service.getHistory(0,10)).thenReturn(response);
		
		mockMvc.perform(get("/alerts/fire/history"))
