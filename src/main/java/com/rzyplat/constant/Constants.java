...
public class Constants {
	...
	public static final String DEVICE_FILE_EMPTY="the uploaded file is empty.";

	public static final String DEVICE_TYPE_CREATED="device type created successfully.";
	public static final String DEVICE_TYPES_CREATED="device types created successfully.";
